...
async def embed(ctx,
    ...
    if id == "welcome":
        ...
        await ctx.channel.send("-# Not an official Minecraft product or service. Not approved by or associated with Mojang or Microsoft. [Licensing, Attributions & Acknowledgements](https://vampirism.co/licensing)")
    elif id == "rules":
        embeds = [
